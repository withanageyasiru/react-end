      ...
      <MDBModal isOpen={this.state.modal8} toggle={this.toggle(8)} fullHeight position="right">
        ...
        this.state.arri.map(far =>{
          ...
          <div className="col-sm-10">
               <h6>Asset Details..</h6>
               <b>VGA: {far.vga}</b><br/>
               <b>RAM: {far.memory}</b><br/>
               <b>Capacity: {far.storageCapacity}</b><br/>
               <b>Processor: {far.processor}</b><br/>
               <b>Laptop  Name : {far.laptops.lapName}</b><br/>
               <b>Display Size : {far.laptops.displaySize}</b><br/>
               <b>Other : {far.laptops.other}</b><br/>
          </div>     
               <form >
