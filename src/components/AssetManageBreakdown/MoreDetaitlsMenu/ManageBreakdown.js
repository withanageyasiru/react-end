...
import ButLap from '../poolButtons/ComputerButton'
import ButDesktop from '../poolButtons/ComputerButton'
import ButComponent from '../poolButtons/ComputerButton'
import ButOther from '../poolButtons/ComputerButton'
...
let url = localStorage.getItem("baseUrl") + "api/auth/pool";
