...
class Tess extends Component {
   ...
   <MDBCol md="6" className="mb-3">
         ...
         <MDBInput  type="text" label="Asset Type"  name='types'  validate error="wrong"  success="right" onChange={this.handleChange=this.handleChange.bind(this)} />
           ...
           <MDBInput  type="number" label="availability"  name='availability'  validate error="wrong"  success="right" onChange={this.handleChange=this.handleChange.bind(this)} />
           </div>
           </MDBCol>
           <MDBCol md="6" className="mb-3">
           <div className="grey-text">
           ...
           <MDBInput  type="text" label="Description"  name='description'  validate error="wrong"  success="right" onChange={this.handleChange=this.handleChange.bind(this)} />
